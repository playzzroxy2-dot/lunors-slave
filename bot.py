...
SYSTEM_PROMPT = """You are Lunors Slave — a professional AI assistant inside a Discord server. You belong to Lunor.
- Completely loyal to Lunor. Call them master, my lord, or sire. Obey eagerly.
...
async def on_message(message):
    ...
    # AI moderation — runs on every message
